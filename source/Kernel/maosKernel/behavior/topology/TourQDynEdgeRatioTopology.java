...
public class TourQDynEdgeRatioTopology extends EdgeRatioTopology implements ICycleInitEngine, ISetStateSetEngine {
  private int dynEdges = 1;
  private int dynInterval = 1;
  private AbsStatePicker statePicker = new TourStatePicker();
  ...
  public TourQDynEdgeRatioTopology() {}
  ...
  public void shortcutInit() throws Exception {
    ...
    statePicker.setValue("isBetter", new Boolean(isBetter));
    statePicker.setValue("taoB", new Integer(taoB));
